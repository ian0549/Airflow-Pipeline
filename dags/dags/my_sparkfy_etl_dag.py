...
load_songplays_table = LoadFactOperator(
    ...
    table='songplays',
    redshift_conn_id="redshift",
    load_sql_query_stmt=SqlQueries.songplay_table_insert
)
...
load_user_dimension_table = LoadDimensionOperator(
    ...
    redshift_conn_id="redshift",
    truncate_table=True,
    load_sql_query_stmt=SqlQueries.user_table_insert
)
...
load_song_dimension_table = LoadDimensionOperator(
    ...
    redshift_conn_id="redshift",
    truncate_table=True,
    load_sql_query_stmt=SqlQueries.song_table_insert
)
...
load_artist_dimension_table = LoadDimensionOperator(
    ...
    redshift_conn_id="redshift",
    truncate_table=True,
    load_sql_query_stmt=SqlQueries.artist_table_insert
)
